...
public class Creature {
	...
	public void moveBy(int mx, int my, int mz){
		...
		if (mz == -1){
			moveUpStairs(mz, tile);
		} else
			walkDownStairs(mz, tile);
	...
	/**
	 * Attempts to move the player up the stairs
	 * 
	 * @param mz
	 * @param tile
	 */
	public void moveUpStairs(int mz, Tile tile) {
	...
	/**
	 * Attempts to move the player down the stairs
	 * 
	 * @param mz
	 * @param tile
	 */
	public void walkDownStairs(int mz, Tile tile) {
		if (mz == 1){
